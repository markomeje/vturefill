    ...
    <div class="pt-5">
	    <div class="container pt-5">
	    	<div class="row">
	            ...
	            <div class="col-12 col-md-6 col-lg-6 mb-4">
                    <form action="<?= DOMAIN; ?>" method="get" class="search-categories">
			            <div class="row no-gutters">
			                <div class="col-10">
			                    <div class="form-group input-group-lg mb-0">
			                        <input type="search" name="query" class="form-control backend-search-input border-right-0" placeholder="Search categories" autocomplete="on" value="<?= empty($query) ? '' : $query; ?>">
			                    </div>
			                </div>
			                <div class="col-2">
			...
			<div class="d-flex justify-content-between mb-4">
				<div class="d-flex bg-transparent border align-items-center m-0 p-0 rounded cursor-pointer" data-toggle="modal" data-target="#add-category">
					<small class="border-right px-3 py-2 text-center text-muted">
						<i class="icofont-plus"></i>
					</small> 
					<div class="px-3 py-2 text-muted">Add category</div>
				</div>
